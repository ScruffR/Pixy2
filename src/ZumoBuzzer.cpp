...
/* will use tone() function based on Particle InternetButton library
...
*/
  ...
  {
    #pragma warn Not implemented yet __FUNCTION__ 
  }
  
  void ZumoBuzzer::playFrequency(unsigned int freq, unsigned int duration, unsigned char volume)
  {
    #pragma warn Not implemented yet __FUNCTION__ 
  }
  
  void ZumoBuzzer::playNote(unsigned char note, unsigned int duration, unsigned char volume)
  {
    #pragma warn Not implemented yet __FUNCTION__ 
  }
  
  void ZumoBuzzer::play(const char *sequence)
  {
    #pragma warn Not implemented yet __FUNCTION__ 
  }
  
  void ZumoBuzzer::playFromProgramSpace(const char *sequence_p)
  {
    #pragma warn Not implemented yet __FUNCTION__ 
  }
  ...
  void ZumoBuzzer::init()
  {
    #pragma warn Not implemented yet __FUNCTION__ 
  }
  
  void ZumoBuzzer::setBPM(int beats_per_minute)
  {
    #pragma warn Not implemented yet __FUNCTION__ 
  }
  
  void ZumoBuzzer::playSong(const char* song)
  {
    #pragma warn Not implemented yet __FUNCTION__ 
  }
  
  void ZumoBuzzer::playNote(const char* note, int duration)
  {
    #pragma warn Not implemented yet __FUNCTION__ 
  }
